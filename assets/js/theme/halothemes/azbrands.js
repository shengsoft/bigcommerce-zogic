...
export default class AZBrands {
    ...
    generateAZBrands($azBrands) {
        ...
        var ch = '#';
        $azBrands.append(`<div class="azBrands-group" data-letter="${ch}" id="azBrands-code-123"><h3 class="azBrands-group-title">${ch}</h3><ul class="brandGrid"></ul></div>`);
        $azBrandsTable.append(`<li data-letter="${ch}"><a href="#azBrands-code-123" data-target="azBrands-code-123">${ch}</a></li>`);
        ...
        for (let i = 97; i < 123; i++) {
            ...
            $azBrands.append(`<div class="azBrands-group" data-letter="${ch}" id="azBrands-code-${i}"><h3 class="azBrands-group-title">${ch}</h3><ul class="brandGrid"></ul></div>`);
